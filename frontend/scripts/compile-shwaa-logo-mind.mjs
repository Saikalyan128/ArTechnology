/**
 * Compile assets/targets/shwaa-logo.png → shwaa-logo.mind (Node, no native canvas).
 */
import fs from 'fs';
...
const pngPath = path.join(root, 'assets/targets/shwaa-logo.png');
const outPath = path.join(root, 'assets/targets/shwaa-logo.mind');
